...
prestige = pd.read_csv('pairedwithprestige.csv')
...
with open('aliases_in_filteredfic.tsv', mode = 'w', encoding = 'utf-8') as f:
    f.write('alias\tourname\n')
    for alias, name in allmatches:
        f.write(alias + '\t' + name + '\n')

with open('near_matches_in_filteredfic.tsv', mode = 'w', encoding = 'utf-8') as f:
    f.write('alias\tourname\n')

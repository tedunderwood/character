...
def select_from_source(sourcepath, startdate, enddate, target_authgender):
    '''
    ...
    with open(sourcepath, encoding = "utf-8") as f:
        ...
        for row in reader:
            story = row['docid']
            if story not in authgenders or authgenders[story] != target_authgender:
                continue
            thischar = row['charid']
            gender = row['gender']
    ...
    metapath = '/Users/tunder/Dropbox/python/character/metadata/balanced_authgender_subset.csv'
    ...
    targetdir = '/Users/tunder/data/authgender_subset/'
...
select_from_source("/Users/tunder/Dropbox/python/character/data/chartable18c19c.tsv", 1780, 1900, 'm')
select_from_source("/Users/tunder/Dropbox/python/character/data/chartablepost1900.tsv", 1900, 2010, 'm')
